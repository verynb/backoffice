...
public class CrawlResult {
  ...
  private TransferPageData transferPageData;
  ...
  public TransferPageData getTransferPageData() {
    return transferPageData;
  }

  public void setTransferPageData(TransferPageData transferPageData) {
    this.transferPageData = transferPageData;
  }
